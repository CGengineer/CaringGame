...
namespace UnityEngine.UI
{
    ...
    ///
    /// Use the ILayoutSelfController to manipulate a GameObjectÅfs own RectTransform component, which you attach in the Inspector.Use ILayoutGroup to manipulate RectTransforms belonging to the children of the GameObject.
    ///
    ...
    /// <code>
    /// <![CDATA[
    /// //This script shows how the GameObjectÅfs own RectTransforms can be changed.
