...
namespace UnityEngine.UI
{
        ...
        ILayoutElement
    {
        ...
        /// <summary>
        /// This is an optional ÅeemptyÅf graphic to show that the InputField text field is empty. Note that this Åeempty' graphic still displays even when the InputField is selected (that is; when there is focus on it).
        ...
        ///     void Start()
        ///     {
        ///         // changes the password symbol. 0 = $, 1 = ! 2 = Åí and so on.
        ///         mainInputField.asteriskChar = "$!Åí%&*"[0];
        ///     }
        /// }
        /// ]]>
        ///</code>
