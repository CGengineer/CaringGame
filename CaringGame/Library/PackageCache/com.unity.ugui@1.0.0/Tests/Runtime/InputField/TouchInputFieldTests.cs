...
namespace InputfieldTests
{
    public class TouchInputFieldTests : BaseInputFieldTests, IPrebuildSetup
    {
        ...
        [Test]
        [TestCase("*Az’H09", "*Az’H09", InputField.CharacterValidation.None)]
        [TestCase("*Az’H09?.", "Az09", InputField.CharacterValidation.Alphanumeric)]
        ...
        [UnityTest]
        [TestCase("*Az’H09", "*Az’H09", InputField.CharacterValidation.None, ExpectedResult = null)]
        [TestCase("*Az’H09?.", "Az09", InputField.CharacterValidation.Alphanumeric, ExpectedResult = null)]
