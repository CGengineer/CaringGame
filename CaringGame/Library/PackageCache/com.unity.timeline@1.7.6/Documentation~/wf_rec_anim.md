...
![Red background indicates that youÅfve added an animation curve for the property to the clip](images/timeline_property_red.png)

_Red background indicates that youÅfve added an animation curve for the property to the clip_
