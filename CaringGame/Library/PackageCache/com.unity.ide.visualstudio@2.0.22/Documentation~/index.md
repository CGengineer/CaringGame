...
**Note**: If youfre using a version of the Unity Editor before 2019.4, youfll need to install this package through the package manager.
...
For more information about using Visual Studio with Unity, see [Microsoftfs Visual Studio Tools for Unity documentation](https://docs.microsoft.com/en-us/visualstudio/gamedev/unity/get-started/visual-studio-tools-for-unity).
