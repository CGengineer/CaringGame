...
LetÅfs clarify a bit what Play Mode and Edit Mode test means from the Unity Test Framework perspective: 
...
* Legacy condition: put tests in the projectÅfs [Editor](https://docs.unity3d.com/Manual/SpecialFolders.html) folder.
