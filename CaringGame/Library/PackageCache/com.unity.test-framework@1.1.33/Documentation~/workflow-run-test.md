...
You can also use one of the buttons on the top bar, **Run All** or **Run Selected**. As a result, youÅfll see the test status icon changed and a counter in the top right corner updated:
