...
|| Exclusive checkout or lock | This is locking a file so nobody can touch it. ItÅfs only useful for non-mergeable files, like binaries, images, or art in a video game.|
