...
version control will automatically perform a check in for appropriate folders and files  such as package files and project settings  when itÅfs set up from the Unity Editor. You can view these in the **Changesets tab.**

Once your initial asset check in is complete, youÅfre set up with version control for Unity and ready to create.
